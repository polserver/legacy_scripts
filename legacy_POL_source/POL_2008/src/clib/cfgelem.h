...
public:
	...
	void warn_with_line( const string& errmsg ) const; //dave added 1/15/3
...
protected:
    ...
    //bool read_properties( FILE *fp ); // returns true if got a }, false otherwise.
	//bool read( FILE *fp );

...
unsigned long last_blocks_used = 0;
unsigned long last_bytes_used = 0;
unsigned long last_blocks_free = 0;
unsigned long last_bytes_free = 0;
...
void PrintAllocationData()
{
   ...
   int heapstatus;
   hinfo._pentry = NULL;
   unsigned long blocks_used = 0, bytes_used = 0, blocks_free = 0,bytes_free = 0;

...
{
    MSGBF_GENERIC_COMMAND outmsg;
    outmsg.msgtype = MSGBF_GENERIC_COMMAND_ID;
    outmsg.subcmd = ctBEu16(MSGBF_GENERIC_COMMAND::TYPE_ACTIVATE_CUSTOM_HOUSE_TOOL);
    ...
    //chr->set_script_member("hidden",0);
    //chr->set_script_member("frozen",0);
...
void CustomHousesAdd(MSGD7_AOS_GENERIC_COMMAND* msg)
{
...
void CustomHousesAddMulti(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
...
void CustomHousesErase(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
    if(house == NULL)
...
void CustomHousesClear(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    Character* chr = find_character(serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
...
void CustomHousesQuit(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    Character* chr = find_character(serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
...
void CustomHousesCommit(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
    Character* chr = find_character(serial);
...
void CustomHousesSelectFloor(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
    Character* chr = find_character(serial);
...
void CustomHousesBackup(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
    if(house == NULL)
...
void CustomHousesRestore(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
    Character* chr = find_character(serial);
...
void CustomHousesSynch(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    Character* chr = find_character(serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
...
void CustomHousesRevert(MSGD7_AOS_GENERIC_COMMAND* msg)
{
    u32 serial = cfBEu32(msg->serial);
    UHouse* house = UHouse::FindWorkingHouse(serial);
    Character* chr = find_character(serial);
...
void CustomHousesSendFull(UHouse* house, Client* client, int design)
{
    ...
    MSGD8_CUSTOM_HOUSE_DATA* msg = reinterpret_cast<MSGD8_CUSTOM_HOUSE_DATA*>(&packet[0]);
    msg->msgtype = MSGD8_CUSTOM_HOUSE_DATA_ID;
...
void CustomHousesSendShort(UHouse* house, Client* client)
{
    ...
    msg.subcmd = ctBEu16(MSGBF_GENERIC_COMMAND::TYPE_CUSTOM_HOUSE_SHORT);

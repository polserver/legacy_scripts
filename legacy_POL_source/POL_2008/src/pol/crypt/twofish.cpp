...
//needed?
//bool CCryptTwofish::m_bTablesReady = false;
...
int CCryptTwofish::Pack(void *pvIn, void *pvOut, int len)
{
	unsigned char *pIn = (unsigned char *)pvIn;
	unsigned char *pOut = (unsigned char *)pvOut;
...
void CCryptTwofish::RawDecrypt(unsigned int *pValues, int table)
{

...
// NOTE: TEXTTYPE_NORMAL is used for sysmessages (lower-left), not sure why.
enum UTEXTTYPE {
	TEXTTYPE_NORMAL				=	0x00,	// Normal -- PC speech, also system messages (!)
	TEXTTYPE_SYS_BROADCAST		=	0x01,	// System Broadcast
	TEXTTYPE_EMOTE				=	0x02,

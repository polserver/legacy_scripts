...
char *ParseErrorStr[PERR_NUM_ERRORS] =
{
...
char ident_allowed[] =
    ...
    "abcdefghijklmnopqrstuvwxyz"
    "0123456789"
    "_"; // $%@& removed 9/17/1998 ENS


/* allowed = allowed_table[last_type][this_type] */

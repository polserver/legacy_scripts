...
static void test_los( UObject* src, UObject* target, bool should_have_los )
{
               ...
               bool should_have_los )
{
    ...
    cout << "LOS test: (" << x1 << "," << y1 << "," << int(z1) << ")"
         << " - (" << x2 << "," << y2 << "," << int(z2) << ")"
         << " (" << should_have_los << "):";
    bool res = p_test_realm->has_los( LosObj(x1,y1,z1), LosObj(x2,y2,z2) );
    cout << res << " ";
    if (should_have_los == res)
    {
        cout << "Ok!" << endl;
               ...
               bool should_have_los )
{
    ...
    cout << "LOS test: (" << x1 << "," << y1 << "," << int(z1) << ",ht=" << int(h1) << ")"
         ...
         << " (" << should_have_los << "):";
    bool res = p_test_realm->has_los( LosObj(x1,y1,z1,h1), LosObj(x2,y2,z2,h2) );
    cout << res << " ";
    if (should_have_los == res)
    {
        cout << "Ok!" << endl;

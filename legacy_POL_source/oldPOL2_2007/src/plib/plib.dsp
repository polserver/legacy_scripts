...
# ADD CPP /nologo /MT /W3 /GX /Zd /O2 /I ".." /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D for="if(0); else for" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I ".." /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D for="if(0); else for" /FR /YX /FD /GZ /c

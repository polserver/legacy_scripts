...
void GPopulation::perform_crossover( GPopulation* newpop ) const
{
    ...
    //cout << "son" << endl;
    //(*from_son)->printOn( cout );
    //cout << "daughter" << endl;
    //(*from_daughter)->printOn( cout );
...
/*
GTree* GTree::clone() const
{
    GTree* newtree = new GTree;

    clone_nodes_onto( newtree );

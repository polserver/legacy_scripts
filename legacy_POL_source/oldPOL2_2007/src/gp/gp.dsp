...
# ADD CPP /nologo /MT /W3 /GX /Zd /O2 /I ".." /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "NOMINMAX" /D for="if(0); else for" /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I ".." /D "_DEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D "NOMINMAX" /D for="if(0); else for" /FD /GZ /c
# SUBTRACT CPP /YX /Yc /Yu

...
void PrintHeapData()
{
    ...
    if (mlog.is_open())
    {
        mlog << "[" << buffer << "] Heap (whole):  " << blocks_allocated << " blocks with " << bytes_allocated << " Bytes" << endl;
        mlog << "[" << buffer << "] Heap (delta):  " << delta_blocks << " blocks with " << delta_bytes << " Bytes" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_8        << " of " << requested_8        << " blocks of 8 Byte (" <<    allocated_8        << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_16       << " of " << requested_16       << " blocks of 16 Byte (" <<   allocated_16       << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_32       << " of " << requested_32       << " blocks of 32 Byte (" <<   allocated_32       << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_64       << " of " << requested_64       << " blocks of 64 Byte (" <<   allocated_64       << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_128      << " of " << requested_128      << " blocks of 128 Byte (" <<  allocated_128      << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_512      << " of " << requested_512      << " blocks of 512 Byte (" <<  allocated_512      << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_1024     << " of " << requested_1024     << " blocks of 1 KByte (" <<   allocated_1024     << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_2048     << " of " << requested_2048     << " blocks of 2 KByte (" <<   allocated_2048     << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_4096     << " of " << requested_4096     << " blocks of 4 KByte (" <<   allocated_4096     << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_8192     << " of " << requested_8192     << " blocks of 8 KByte (" <<   allocated_8192     << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_16384    << " of " << requested_16384    << " blocks of 16 KByte (" <<  allocated_16384    << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_65536    << " of " << requested_65536    << " blocks of 64 KByte (" <<  allocated_65536    << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_131072   << " of " << requested_131072   << " blocks of 128 KByte (" << allocated_131072   << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_524288   << " of " << requested_524288   << " blocks of 0.5 MByte (" << allocated_524288   << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_1048576  << " of " << requested_1048576  << " blocks of 1 MByte (" <<   allocated_1048576  << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_16777216 << " of " << requested_16777216 << " blocks of 16 MByte (" <<  allocated_16777216 << ")" << endl;
        mlog << "[" << buffer << "] Heap (blocks): " << used_huge     << " of " << requested_huge     << " huge blocks (" <<         allocated_huge     << ")" << endl;
    }
#endif
}

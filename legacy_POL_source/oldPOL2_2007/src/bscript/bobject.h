...
{
//    passert_always( len == sizeof(BObject) );
...
{
//    passert_always( len == sizeof(UninitObject) );
...
/*
inline Long operator+(Long& a, Long& b) { return Long(a.lval + b.lval); }
inline Long operator-(Long& a, Long& b) { return Long(a.lval - b.lval); }
inline Long operator*(Long& a, Long& b) { return Long(a.lval * b.lval); }
inline Long operator/(Long& a, Long& b)
{
    if (b.lval) return Long(a.lval / b.lval);
    else return Long(MAXLONG);
}
*/
...
/*
// stack
class ObjectStack : public RStack<BObject>
{
  protected:
    virtual void destroy(void* data)
      {
        //  TMALLOC passert(tm_isalloced(data)); 
        delete (BObject *) data;
      }
  public:
    ObjectStack() : RStack<BObject>(0, 3) { }
    virtual ~ObjectStack() { flush(); }
};
*/
...
/*
template<class T>
BObjectImp *BApplicObj<T>::copy() const
{
    return new BApplicObj<T>(object_type(), obj_);
}
*/

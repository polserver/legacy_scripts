...
static char* poldbg_base_members[] = {  "x", "y", "z", "name", "objtype", "graphic",
										"serial", "color", "facing", "height", "weight",
										"multi", "realm" };

static char* poldbg_itemref_members[] = {"amount", "layer", "container", "usescript",
										 "equipscript", "desc", "movable", "invisible",
										 "decayat", "sellprice", "buyprice", "newbie"};

static char* poldbg_mobileref_members[] = { "warmode", "gender", "race", "trueobjtype",
